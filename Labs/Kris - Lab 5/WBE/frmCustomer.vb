Imports libWBEData
Imports libWBEBR
'todo   make tab order sensible (like down one column and then down the next)
'       Driver and contact out of order
'todo   State would be better in a combo box (style - dropDown list)
'todo   Style of driver combo box would be better as dropDownlist
    ...
    Private Sub SaveCustomer()
        ...
        If IsValidData(objCustomer) Then
            ...
            Else  'If CustID = 0, then new customer.
                'todo   for new customers, set LastOrderDate = yesterday
                '       LastCountdate = today
